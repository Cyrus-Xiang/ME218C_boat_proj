...
#define SERV_0_HEADER "ThrusterService.h"
// the name of the Init function
#define SERV_0_INIT InitThrusterService
// the name of the run function
#define SERV_0_RUN RunThrusterService
...
#if NUM_SERVICES > 1
// the header file with the public function prototypes
#define SERV_1_HEADER "ThrusterService.h"
// the name of the Init function
#define SERV_1_INIT InitThrusterService
// the name of the run function
#define SERV_1_RUN RunThrusterService
// How big should this services Queue be?
